...
namespace Atcmobapp\Meta\View\Helper;
 ...
 *
 * @property \Atcmobapp\Core\View\Helper\HtmlHelper $Html
 */
class MetaHelper extends Helper
{
    ...
    public $settings = [
        'deleteUrl' => [
            'prefix' => 'admin', 'plugin' => 'Atcmobapp/Meta',
    ...
    public function beforeRender($viewFile)
    {
        if ($this->Layout->isLoggedIn()) {
            return $this->Atcmobapp->adminScript('Atcmobapp/Meta.admin');
        }
    }
