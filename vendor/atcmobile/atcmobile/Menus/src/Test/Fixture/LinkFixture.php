...
class LinkFixture extends AtcmobappTestFixture
{
    ...
    public $records = [
        [
            ...
            'class' => 'about',
            'description' => '',
            'link' => 'plugin:Atcmobapp/Nodes|controller:Nodes|action:view|type:page|slug:about',
            'target' => '',
            'rel' => '',
            'status' => 1,
            'lft' => 3,
        ...
        [
            ...
            'class' => 'contact',
            'description' => '',
            'link' => 'plugin:Atcmobapp/Contacts|controller:Contacts|action:view|contact',
            'target' => '',
            'rel' => '',
            'status' => 1,
            'lft' => 5,
        ...
        [
            ...
            'class' => 'contact',
            'description' => '',
            'link' => 'plugin:atcmobile/Contacts|controller:Contacts|action:view|contact',
            'target' => '',
            'rel' => '',
            'status' => 1,
            'lft' => 7,
