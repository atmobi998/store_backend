...
namespace Atcmobapp\Menus\Test\TestCase\View\Helper;

use App\Controller\Component\SessionComponent;
use Cake\Controller\Controller;
use Atcmobapp\Core\TestSuite\TestCase;
...
class MenusHelperTest extends TestCase
{
    ...
    public function testMenuShortcode()
    {
        ...
        Atcmobapp::dispatchEvent('Helper.Layout.beforeFilter', $this->View, ['content' => &$content]);
