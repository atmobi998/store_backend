...
namespace Atcmobapp\Menus\Controller\Component;
 ...
 * @package Atcmobapp.Menus.Controller.Component
 */
class MenuComponent extends Component
{
    ...
    public function startup(Event $event)
    {
        ...
        if (isset($this->controller->Link)) {
            ...
            $this->Links = TableRegistry::get('Atcmobapp/Menus.Links');
        }
    ...
    public function menus()
    {
        ...
        if (Configure::read('Site.theme')) {
            $themeData = (new AtcmobappTheme)->getData(Configure::read('Site.theme'));
