...
class TypesTable extends AtcmobappTable
{
    ...
    {
        $validator->notBlank('title', __d('atcmobile', 'Title cannot be empty.'));
        $validator->notBlank('alias', __d('atcmobile', 'Alias cannot be empty.'));
