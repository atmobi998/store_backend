...
class TermsController extends AppController
{
    ...
    public function delete($id = null, $vocabularyId = null)
    {
        ...
        if ($success) {
            $messageFlash = __d('atcmobile', 'Term deleted');
            $flashMethod = 'success';
        } else {
            $messageFlash = __d('atcmobile', 'Term could not be deleted. Please, try again.' . ' ' . $error);
            $flashMethod = 'error';
        }
    ...
    public function edit($id)
    {
        ...
        if ($request->is('post') || $request->is('put')) {
            ...
            if ($saved) {
                $this->Flash->success(__d('atcmobile', 'Term saved successfuly.'));
                ...
                $this->Flash->error(__d('atcmobile', 'Term could not be added to the vocabulary. Please try again.'));
            }
        }
