...
namespace Atcmobapp\Comments\Model\Table;
 ...
 *
 * @category Model
 * @package  Atcmobapp.Comments.Model
 * @version  1.0
 * @author   ATC Mobile Team <hotranan@gmail.com>
 * @license  http://www.opensource.org/licenses/mit-license.php The MIT License
 * @link     http://metroeconomics.com
 */
class CommentsTable extends AtcmobappTable
{
    ...
    {
        $this->setEntityClass('Atcmobapp/Comments.Comment');
        ...
        $this->addBehavior('Atcmobapp/Core.LinkedModel');
        ...
        $this->getEventManager()->on($this->getMailer('Atcmobapp/Comments.Comment'));
    }
    ...
    public function isValidLevel($commentId)
    {
        if (!$this->exists(['id' => $commentId])) {
            throw new NotFoundException(__d('atcmobile', 'Invalid Comment id'));
        }
