...
namespace Atcmobapp\Comments\Model\Behavior;
 ...
 * @package  Atcmobapp.Comments.Model.Behavior
...
class CommentableBehavior extends Behavior
{
    public function initialize(array $config)
    {
        $this->_table->hasMany('Comments', [
            'className' => 'Atcmobapp/Comments.Comments',
    ...
    public function getTypeSetting(Node $node)
    {
        ...
        $types = TableRegistry::get('Atcmobapp/Taxonomy.Types');
