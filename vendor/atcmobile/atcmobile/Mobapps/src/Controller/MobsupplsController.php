 ...
 */
class MobsupplsController extends AppController
{
    ...
    public function beforeFilter(Event $event)
    {
        ...
        $this->Auth->allow(['addsupl', 'delsupl', 'editsupl', 'getsupl', 'suplqry']);
    }

    public function addsupl()
    {
