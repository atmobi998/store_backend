 ...
 */
class MobordprdsController extends AppController
{
    ...
    public function beforeFilter(Event $event)
    {
        ...
        $this->Auth->allow(['addordprd', 'delordprd', 'editordprd', 'getordprd', 'ordprdqry']);
    }

    public function addordprd()
    {
