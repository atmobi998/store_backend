 ...
 */
class MobusrctlsController extends AppController
{
    ...
    public function beforeFilter(Event $event)
    {
        ...
        $this->Auth->allow([ 'usrtoken', 'postoken', 'addsess', 'editsess', 'sessqry', 'addprod', 'editprod', 'prodqry', 'addcat', 'delcat', 'editcat', 'catqry', 'detadd', 'detdel', 'detedit', 'detqry', 'tktadd', 'tktedit', 'tktqry' ]);
    }
