...
class MobappsController extends AppController
{
    ...
    public function beforeFilter(Event $event)
    {
        ...
        $this->Auth->allow(['addapp', 'delapp', 'editapp', 'getapp', 'appqry', 'register', 'login', 'token', 'userinfo', 'listbyemail']);
    }
    ...
    public function register() {
        ...
        if (!empty($thisdata)) {
            ...
            if ($existprofiles) {
                $regvalidate=false;
                $return_code['reg']=-1;
                $return_code['regerr']='Username already exists.';
            } else if (empty($thisdata['username'])) {
                $regvalidate=false;
                $return_code['reg']=-1;
                $return_code['regerr']='Please enter your username.';
                ...
                $regvalidate=false;
                $return_code['reg']=-1;
                $return_code['regerr']='Please enter your phone.';
            }
        } 
