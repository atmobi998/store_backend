 ...
 */
class MobprdoptsController extends AppController
{
    ...
    public function beforeFilter(Event $event)
    {
        ...
        $this->Auth->allow(['addprdopt', 'delprdopt', 'editprdopt', 'getprdopt', 'prdoptqry']);
    }

    public function addprdopt()
    {
