...
class MobdrvtransInitialMigration extends AbstractMigration
{
    public function up()
    {

    $this->table('mobdrvtrans',['id' => false, 'primary_key' => ['id']])
        ...
        ->addColumn('drv_id', 'biginteger', [ 'default' => null, 'limit' => 20, 'null' => false ])
    ...
    {
        $this->table('mobdrvtrans')->drop()->save();
    }
}
