...
class MobsubcatsInitialMigration extends AbstractMigration
{
    public function up()
    {

    $this->table('mobsubcats',['id' => false, 'primary_key' => ['id']])
        ...
        ->addColumn('cat_id', 'biginteger', [ 'default' => null, 'limit' => 20, 'null' => false ])
    ...
    {
        $this->table('mobsubcats')->drop()->save();
    }
}
