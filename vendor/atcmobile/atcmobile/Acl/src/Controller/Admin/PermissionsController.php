...
class PermissionsController extends AppController
{
    ...
    public function initialize()
    {
        ...
        $this->loadModel('Atcmobapp/Acl.Acos');
        $this->loadModel('Atcmobapp/Acl.Aros');
        $this->loadModel('Atcmobapp/Users.Roles');
        $this->loadModel('Atcmobapp/Acl.Permissions');
    }
    ...
    public function index($id = null, $level = null)
    {
        ...
        if ($this->getRequest()->is('ajax') && isset($query)) {
            $this->render('Atcmobapp/Acl.acl_permissions_table');
        } else {
    ...
    protected function _setPermissionRoots()
    {
        ...
        foreach ($roots as $id => $root) {
            Atcmobapp::hookAdminTab(
                'Admin/Permissions/index',
                __d('atcmobile', $root->title),
                'Atcmobapp/Core.blank',
                [
                    'linkOptions' => [
