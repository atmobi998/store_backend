...
namespace Atcmobapp\Acl\View\Helper;
...
class AclHelper extends Helper
{
    ...
    public function linkIsAllowedByUserId($userId, $url)
    {
        ...
        if ($linkAction == '/') {
            $linkAction = 'controllers/Atcmobapp\\Nodes/Nodes/promoted';
        }
        if ($linkAction == '/admin') {
            $linkAction = 'controllers/Atcmobapp\\Dashboards/Admin/Dashboards/dashboard';
        }
