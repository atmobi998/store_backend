...
namespace Atcmobapp\Acl\Controller\Component\Auth;
 ...
 * }}}
 *
 * @package     Atcmobapp.Acl.Controller.Component.Auth
 */
class TokenAuthenticate extends BaseAuthenticate
{
    ...
    public function __construct(ComponentRegistry $collection, $settings)
    {
        ...
        if (empty($this->settings['parameter']) && empty($this->settings['header'])) {
            throw new Exception(__d('atcmobile', 'You need to specify token parameter and/or header'));
        }
    }
