...
use Atcmobapp\Translate\Middleware\I18nMiddleware;

// Uncomment if to enable locale detection via Accept-Language header
// DispatcherFactory::add('Atcmobapp/Translate.LocaleSelector');
$Languages = TableRegistry::get('Atcmobapp/Settings.Languages');
