...
namespace Atcmobapp\Blocks\Controller\Component;
...
use Atcmobapp\Blocks\Model\Entity\Block;
use Atcmobapp\Core\Utility\StringConverter;
use Atcmobapp\Core\Utility\VisibilityFilter;

/**
 * Blocks Component
 *
 * @package Atcmobapp.Blocks.Controller.Component
 */
class BlocksComponent extends Component
{
    ...
    public function beforeFilter(Event $event)
    {
        ...
        if (isset($this->controller->Blocks)) {
            ...
            $this->Blocks = TableRegistry::get('Atcmobapp/Blocks.Blocks');
        }
    }
    ...
    public function blocks()
    {
        ...
        foreach ($regions as $regionId => $regionAlias) {
            ...
            $blocks = Cache::read($visibilityCachePrefix, 'atcmobile_blocks');
            if ($blocks === false) {
                ...
                $blocks = $Filter->remove($blocks->all(), [
                    ...
                    'cache' => [
                        ...
                        'config' => 'atcmobile_blocks',
                    ],
                ]);

                Cache::write($visibilityCachePrefix, $blocks->toArray(), 'atcmobile_blocks');
            }
