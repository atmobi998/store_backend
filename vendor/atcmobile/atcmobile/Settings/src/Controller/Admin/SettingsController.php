...
success:
                $this->Flash->success(__d('atcmobile', 'Settings updated successfully'));
            } catch (Exception $e) {
                $this->Flash->error(__d('atcmobile', 'Settings cannot be updated: ' . $e->getMessage()));
            }
        ...
        if ($settings->count() == 0) {
            $this->Flash->error(__d('atcmobile', 'Invalid Setting key'));
        }
