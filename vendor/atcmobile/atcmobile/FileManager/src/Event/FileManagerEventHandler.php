 ...
 *
 * @category Event
 * @package  Atcmobapp.FileManager.Event
...
class FileManagerEventHandler implements EventListenerInterface
{
    ...
    public function onNewAttachment($event)
    {
        ...
        $Attachments = TableRegistry::get('Atcmobapp/FileManager.Attachments');
        if (
        ...
        $Usage = TableRegistry::get('Atcmobapp/FileManager.AssetUsages');
