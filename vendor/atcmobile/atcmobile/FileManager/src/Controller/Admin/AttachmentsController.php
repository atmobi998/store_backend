 ...
 * @author   ATC Mobile Team <contact@metroeconomics.com>
...
class AttachmentsController extends AppController
{
     ...
     */
    public $helpers = [
        'Atcmobapp/FileManager.AssetsImage',
    ...
    public function initialize()
    {
        ...
        $this->loadModel('Atcmobapp/FileManager.Attachments');
    }
    ...
    {
        $this->set('title_for_layout', __d('atcmobile', 'Attachments'));
    ...
    public function add()
    {
        $this->set('title_for_layout', __d('atcmobile', 'Add Attachment'));
        ...
        if ($this->getRequest()->is('post')) {
            ...
            if (!empty($data)) {
                ...
                $errors = [
                    'file' => __d('atcmobile', 'Upload failed. Please ensure size does not exceed the server limit.')
                ];
            }
            ...
            if (empty($errors)) {
                ...
                if (empty($errors) && $attachment) {
                    ...
                    Atcmobapp::dispatchEvent($eventKey, $this, compact('attachment'));
                } else {
            ...
            if ($attachment) {
                $this->Flash->success(__d('atcmobile', 'The Attachment has been saved'));
                $url = [];
                ...
                $this->Flash->error(__d('atcmobile', 'The Attachment could not be saved. Please, try again.'));
            }
        } else {
            // noop
        }
    ...
    {
        $this->set('title_for_layout', __d('atcmobile', 'Edit Attachment'));
        ...
        if (!$id && empty($this->getRequest()->getData())) {
            $this->Flash->error(__d('atcmobile', 'Invalid Attachment'));
    ...
    {
        if (!$id) {
            $this->Flash->error(__d('atcmobile', 'Invalid id for Attachment'));
        ...
        if ($this->Attachments->delete($attachment)) {
            ...
            $this->Flash->success(__d('atcmobile', 'Attachment deleted'));
    ...
    public function process()
    {
        ...
        $messageMap = [
            'delete' => __d('atcmobile', 'Attachments deleted'),
        ];
