...
class Atcmobapp
{
     ...
     *
     * @param string $tableName Table name (for e.g., Atcmobapp/Nodes.Nodes)
     ...
     *
     * @param string $controllerName Controller name (for e.g., Atcmobapp/Nodes.Nodes)
    ...
    {
        Atcmobapp::mergeConfig('Translate.models', [
            $model => $config
        ], true);
    }
}
