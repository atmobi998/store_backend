...
$this->Breadcrumbs
    ->add(__d('atcmobile', '<%= $pluralHumanName %>'), ['action' => 'index']);
...
$this->append('action-buttons');
    echo $this->Atcmobapp->adminAction(__('Edit <%= $singularHumanName %>'), ['action' => 'edit', <%= $pk %>]);
    echo $this->Atcmobapp->adminAction(__('Delete <%= $singularHumanName %>'), ['action' => 'delete', <%= $pk %>], ['confirm' => __('Are you sure you want to delete # {0}?', <%= $pk %>)]);
    echo $this->Atcmobapp->adminAction(__('List <%= $pluralHumanName %>'), ['action' => 'index']);
    echo $this->Atcmobapp->adminAction(__('New <%= $singularHumanName %>'), ['action' => 'add']);
<%
    $done = [];
...
%>
        echo $this->Atcmobapp->adminAction(__('List <%= $this->_pluralHumanName($alias) %>'), ['controller' => '<%= $details['controller'] %>', 'action' => 'index']);
        echo $this->Atcmobapp->adminAction(__('New <%= Inflector::humanize(Inflector::singularize(Inflector::underscore($alias))) %>'), ['controller' => '<%= $details['controller'] %>', 'action' => 'add']);
<%
