...
use Atcmobapp\Core\Configure\JsonReader;
use Atcmobapp\Core\PluginManager;
use Atcmobapp\Core\TestSuite\AtcmobappTestFixture;
 ...
 */
class AtcmobappControllerTestCase extends TestCase
{
    ...
    {
        $configDir = Plugin::path('Atcmobapp/Core') . 'tests' . DS . 'test_app' . DS . 'config' . DS;
    ...
    public function setUp()
    {
        ...
        $appDir = Plugin::path('Atcmobapp/Core') . 'tests' . DS . 'test_app' . DS;
 ...
 */
//      Plugin::load(array('Atcmobapp/Users'), ['bootstrap' => true, 'path' => '../Users/', 'autoload' => true]);
