...
use Atcmobapp\Core\TestSuite\Constraint\EntityHasProperty;
...
class IntegrationTestCase extends CakeIntegrationTestCase
{
    ...
    /**
     * @param \Atcmobapp\Users\Model\Entity\User|\Cake\ORM\Query|string $user
     */
    public function user($user)
    {
        if (is_string($user)) {
            $user = TableRegistry::get('Atcmobapp/Users.Users')
                ->findByUsername($user);
        }
