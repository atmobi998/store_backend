...
namespace Atcmobapp\Core\Model\Table;
...
use Atcmobapp\Core\PropertyHookTrait;

/**
 * Atcmobapp Base Table class
 *
 * @category Atcmobapp.Model
 * @package  Atcmobapp.Atcmobapp.Model.Table
 * @version  1.5
 * @author   ATC Mobile Team <hotranan@gmail.com>
 * @license  http://www.opensource.org/licenses/mit-license.php The MIT License
 * @link     http://metroeconomics.com
 */
class AtcmobappTable extends Table
{
    ...
    {
        Atcmobapp::applyHookProperties('Hook.table_properties', $this);
    ...
    {
        return parent::invalidate($field, __d('atcmobile', $value));
    }
