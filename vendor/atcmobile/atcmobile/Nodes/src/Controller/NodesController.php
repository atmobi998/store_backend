...
namespace Atcmobapp\Nodes\Controller;
...
class NodesController extends AppController
{
    ...
    public function index()
    {
        ...
        if ($this->usePaginationCache) {
            $cacheNamePrefix = 'nodes_index_' . $this->Atcmobapp->roleId() . '_' . $locale;
            if (isset($type)) {
    ...
    public function search($typeAlias = null)
    {
        ...
        if ($typeAlias) {
            ...
            if (!isset($type['Type']['id'])) {
                $this->Flash->error(__d('atcmobile', 'Invalid content type.'));
