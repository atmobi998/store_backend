...
namespace Atcmobapp\Nodes\View\Helper;
...
class NodesHelper extends Helper
{
     ...
     * Current Node
     *
     * @var \Atcmobapp\Nodes\Model\Entity\Node
     * @access public
     */
    public $node = null;
    ...
    public function nodeList($alias, $options = [])
    {
        $_options = [
            ...
            'controller' => 'Nodes',
            'action' => 'view',
            'element' => 'Atcmobapp/Nodes.node_list',
        ];
    ...
    {
        $event = Atcmobapp::dispatchEvent('Helper.Nodes.beforeSetNode', $this->_View, [
            'node' => $node,
        ]);
        $this->node = $event->getData('node');
        $this->Layout->hook('afterSetNode');
        Atcmobapp::dispatchEvent('Helper.Nodes.afterSetNode', $this->_View, [
            'node' => $this->node
        ]);
    }
    ...
    {
        $_options = [
            'element' => 'Atcmobapp/Nodes.node_info',
        ];
        $options = array_merge($_options, $options);
    ...
    {
        $_options = [
            'element' => 'Atcmobapp/Nodes.node_excerpt',
            'body' => false,
        ];
        $options = array_merge($_options, $options);
    ...
    {
        $_options = [
            'element' => 'Atcmobapp/Nodes.node_body',
        ];
        $options = array_merge($_options, $options);
    ...
    {
        $_options = [
            'element' => 'Atcmobapp/Nodes.node_more_info',
        ];
        $options = array_merge($_options, $options);
     ...
     *
     * @param \Atcmobapp\Nodes\Model\Entity\Node $node Node data
     * @param bool $full
     * @return string
     */
    ...
    {
        return Plugin::isLoaded('Atcmobapp/Comments');
    }
}
