...
namespace Atcmobapp\Install\Model\Table;
...
class InstallTable extends Table
{
    ...
    public function addAdminUser($user)
    {
        ...
        if ($errors) {
            ...
            throw new PersistenceFailedException($entity, __d('atcmobile', 'Unable to create administrative user. Validation errors: %s (%s)', $message, $field));
        }
